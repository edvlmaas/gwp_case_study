...
suppressMessages({
  ...
  livec_output_base1 <- read.table(paste0(daycent_path,paste0("livec_base1_",scenario_name,".out")),
                                  ...
                                  colClasses=c("numeric","numeric","numeric","numeric","numeric",
                                               ...
                                               "numeric","numeric"),
                                  skip=1)
  livec_output_base2 <- read.table(paste0(daycent_path,paste0("livec_base2_",scenario_name,".out")),
                                   col.names = c("time","dayofyr","aglivc","bglivcj","bglivcm","rleavc",
                                                 "frootcj","frootcm","fbrchc","rlwodc","crootc","frnutc"),
                                   colClasses=c("numeric","numeric","numeric","numeric","numeric",
                                                "numeric","numeric","numeric","numeric","numeric",
  ...
  livec_output <- rbind(livec_output_base1,livec_output_base2,livec_output_exp,livec_output_fut) %>%
