#######################################
# Function: f_model_coef.R
# Author: Ellen Maas
# Date: Jan 27, 2023
# Description: Accepts data for a model (or all), climate scenario,
# and management scenario and calculates the linear regression,
# returning the coefficients to construct the lines on graphs. 
#######################################
