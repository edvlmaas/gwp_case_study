#######################################
# Function: 2_Create_soil_data-Daycent.R
# Author: Ellen Maas
# Date: July 11, 2022
...
print("2_Create_soil_data-Daycent.R")

###########################
#Daycent
###########################

#soil_df$ksat_cmsec <- soil_df$ksat_cmsec*2
#soil_df$ksat_cmsec <- c(0.01,0.01,0.01,0.01,0.01,0.01,0.0055,0.000055,0.00055,0.00055,0.00055,0.00055,0.00055)
...
write.table(soil_df[,c("upper_depth_cm","lower_depth_cm","BD","DUL","LL15","evap_coef",
            ...
            file=paste0(daycent_path,"soils_",treatment_num,".in"),
