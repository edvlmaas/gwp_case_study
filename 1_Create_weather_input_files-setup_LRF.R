...
#  1) site data
#  2) IEM data  (Iowa Environmental Mesonet)
#  3) NASA POWER 
#  Using APSIM functions for data retrieval (steps 2 and 3) means that there are 
#  no further gaps.
#######################################
...
###########################
## import fill-in from Mesonet and NASA Power (called by get_power_apsim_met)
###########################
