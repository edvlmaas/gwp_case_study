#######################################
# File: 3_Create_management_input_files-setup_KBS.R
# Author: Ellen Maas
# Date: Sept 23, 2022
...
resid_adjust_chr <- if_else(mgmt_scenario_num==51, "50", # incorporate 50% residue
                ...
                if_else(mgmt_scenario_num==53, "0",      # incorporate 100% residue
...
resid_adjust <- if_else(mgmt_scenario_num==51, 0.50, # incorporate 50% residue
                ...
                if_else(mgmt_scenario_num==53, 0,    # incorporate 100% residue: baseline
...
temp_ops_ext_adj <- ops_ext_adj[(ops_ext_adj$observation_type!="Fertilizer application"),
  ...
  mutate(date = as.Date(date,format="%m/%d/%Y"),
         ...
         seed_depth_mm = 50,
         # translate crops to APSIM codes
         cultivar = ifelse(crop=="Maize","Zhongdan2", # was B_80
                    ifelse(crop=="Soybean"&treatment_num %in% c(54,55,56),"MG_3",
                    ifelse(crop=="Soybean"&treatment_num==3,"MG_3",
                    ifelse(crop=="Soybean","MG_4",
                    ifelse(crop=="Wheat","Adagio",
         ...
         p_rate_g_m2=NA,
         k_rate_g_m2=NA,
         # translate crops and field ops to Daycent codes
         daycent_mgmt_code=if_else(obs_code=="plow","CULT K",
                           ...
                           if_else(obs_code=="plant"&crop=="Maize"&year<2011&treatment_num==3,"CROP C7",
                           if_else(obs_code=="plant"&crop=="Maize"&year<2011,"CROP C6",
                           if_else(obs_code=="plant"&crop=="Maize"&year>=2011&treatment_num==3,"CROP C8",
                           if_else(obs_code=="plant"&crop=="Maize"&year>=2011&treatment_num %in% c(54,55,56),"CROP C8",
                           if_else(obs_code=="plant"&crop=="Maize"&year>=2011,"CROP C7",
                           if_else(obs_code=="plant"&crop=="Soybean"&year<2015&treatment_num==3,"CROP SYBN3",
                           if_else(obs_code=="plant"&crop=="Soybean"&year>=2015&treatment_num==3,"CROP SYBN5",
                           if_else(obs_code=="plant"&crop=="Soybean"&year<2015&treatment_num %in% c(54,55,56),"CROP SYBN2",
                           if_else(obs_code=="plant"&crop=="Soybean"&year>=2015&treatment_num %in% c(54,55,56),"CROP SYBN5",
                           if_else(obs_code=="plant"&crop=="Soybean"&year<2015,"CROP SYBN4",
                           if_else(obs_code=="plant"&crop=="Soybean"&year>=2015,"CROP SYBN5",
                           #if_else(obs_code=="plant"&crop=="Wheat","CROP W4EG",
                           if_else(obs_code=="plant"&crop=="Wheat"&year<2018,"CROP W3",
                           if_else(obs_code=="plant"&crop=="Wheat"&year>=2018,"CROP W4EG",
                           ...
                           ## residue removed after wheat, retained after corn and soybeans
                           if_else(obs_code=="grain"&crop=="Maize","HARV G",
                           if_else(obs_code=="grain"&crop=="Soybean","HARV G", 
                           if_else(obs_code=="grain"&crop=="Wheat","HARV G90S", 
