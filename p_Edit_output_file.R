#######################################
# Function: p_Edit_output_file.R
# Author: Ellen Maas
# Date: Nov. 4, 2022
# Output: It creates an output file with summary data of 
# totals and differences in yield and GWP components, by
# model and scenario. If the file already exists, it checks 
# to see if a record already exists for the model and 
# scenario. If it does, it replaces the data, otherwise 
# it appends it to the end.
#######################################
